    ...
    (() => {
        ...
        function showMore() {
            window.addEventListener("load", (function(e) {
                ...
                function showMoreActions(e) {
                    ...
                    const none = document.querySelector(".button-block");
                    if (targetType === "click") {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new core(".swiper", {
                modules: [ Navigation, Scrollbar, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
            ...
            if (document.querySelector(".swiper__antena")) new core(".swiper__antena", {
                modules: [ Navigation, Scrollbar, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".swiper__klon")) new core(".swiper__klon", {
                modules: [ Navigation, Scrollbar, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        showMore();
        pageNavigation();
        const btnBlue = document.querySelector(".info-main-block__button.blue");
        const btnPink = document.querySelector(".info-main-block__button.pink");
        const btnGreen = document.querySelector(".info-main-block__button.green");
        const sliderBlue = document.querySelector(".main-block__slider.blue");
        const sliderPink = document.querySelector(".main-block__slider.pink");
        const sliderGreen = document.querySelector(".main-block__slider.green");
        btnBlue.addEventListener("click", (function() {
            btnPink.classList.remove("active");
            btnGreen.classList.remove("active");
            sliderPink.classList.add("none");
            sliderGreen.classList.add("none");
            sliderBlue.classList.remove("none");
            this.classList.add("active");
        }));
        btnPink.addEventListener("click", (function() {
            btnBlue.classList.remove("active");
            btnGreen.classList.remove("active");
            sliderBlue.classList.add("none");
            sliderGreen.classList.add("none");
            sliderPink.classList.remove("none");
            this.classList.add("active");
        }));
        btnGreen.addEventListener("click", (function() {
            ...
            sliderPink.classList.add("none");
            sliderBlue.classList.add("none");
            sliderGreen.classList.remove("none");
            this.classList.add("active");
        }));
    })();
})();