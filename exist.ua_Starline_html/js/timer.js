(() => {
	...
	var deadline = "December 27 2023 23:59:59 GMT+0200";
	initializeClock("clockdiv", deadline);
	document.querySelectorAll(".main-block__button").forEach((function(currentBtn) {
		 currentBtn.addEventListener("click", (function() {
			  document.querySelector(".links").classList.toggle("none");
		 }));
	}));
	window["FLS"] = true;
	isWebp();
