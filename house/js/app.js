(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-house")) new swiper_core_Swiper(".swiper-house", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-assortment")) new swiper_core_Swiper(".swiper-assortment", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".swiper-button-prev-assortment",
                nextEl: ".swiper-button-next-assortment"
            },
            on: {}
        });
    }
